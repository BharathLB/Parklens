...
const HistoryPage = () => {
  const table1Data = React.useRef([
    {
      ...
      rowviolationtime: "07/11/2023-02:00:01",
  ...
  const table1Columns = React.useMemo(() => {
    ...
    return [
      table1ColumnHelper.accessor("rowgroup101", {
        cell: (info) => (
          <Text
        ...
        header: (info) => (
          <div className="flex flex-row gap-[5px] items-end justify-start min-w-[163px]">
            <Text
      ...
      table1ColumnHelper.accessor("rowstall", {
        cell: (info) => (
          <Text
            className="pb-[18px] pt-[35px] text-black-900 text-sm"
            size="txtInterRegular14Black900"
        ...
        header: (info) => (
          <div className="flex flex-row gap-1.5 items-start justify-start min-w-[162px]">
            <Text
              className="text-black-900 text-sm"
              size="txtInterRegular14Black900"
            >
      ...
      table1ColumnHelper.accessor("rowgroup106", {
        cell: (info) => (
          <Text
        ...
        header: (info) => (
          <div className="flex flex-row gap-[7px] items-start justify-start min-w-[237px]">
            <Text
              className="text-black-900 text-sm"
              size="txtInterRegular14Black900"
            >
      ...
      table1ColumnHelper.accessor("rowviolationtime", {
        cell: (info) => (
          <div className="flex flex-row gap-[136px] items-start justify-center pr-[15px] py-[15px]">
            <Text
            ...
            <Input
              ...
              wrapClassName="bg-cover bg-no-repeat h-[25px] max-w-[74px] mr-[109px] mt-[17px] p-[3px]"
              style={{ backgroundImage: "url('images/img_group112.svg')" }}
            ></Input>
          </div>
        ),
        header: (info) => (
          <div className="flex flex-row gap-[183px] items-start justify-center min-w-[471px]">
            <div className="h-[17px] relative w-[23%]">
              <Text
                className="text-black-900 text-sm"
                size="txtInterRegular14Black900"
              >
            ...
            <div className="flex md:flex-col flex-row md:gap-5 items-start justify-end overflow-auto w-full">
              ...
              >
                ...
                <Menu
                  ...
                  className="flex flex-col items-center justify-start mb-[757px] mt-5 w-full"
                >
              ...
              <div className="flex flex-1 flex-col gap-5 justify-start w-full">
                ...
                <div className="flex flex-col gap-5 items-center justify-start ml-6 md:ml-[0] md:px-5 w-[81%] md:w-full">
                  <div className="flex md:flex-col flex-row md:gap-5 items-center justify-start w-full">
                    ...
                    <div
                      className="bg-cover bg-no-repeat flex md:flex-1 flex-col h-[50px] items-center justify-end md:ml-[0] ml-[241px] p-[7px] w-[19%] md:w-full"
                      style={{
                    ...
                    >
                      <div className="flex flex-col items-start justify-start w-[97%] md:w-full">
                        ...
                        <SelectBox
                          ...
                          isSearchable={false}
                          placeholder="07/11/2023 to 08/11/2023  "
                        />
                      </div>
                    </div>
                    <List
                      className="md:flex-1 sm:flex-col flex-row gap-[13px] grid sm:grid-cols-1 grid-cols-3 md:ml-[0] ml-[15px] w-[43%] md:w-full"
